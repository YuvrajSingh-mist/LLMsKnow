...
def convert_excel_to_qna(excel_file, output_file, system_instruction):
    """Convert Excel data to QnA format for use with the Maradona model"""
...
def main():
    parser = argparse.ArgumentParser(description="Convert Excel data to QnA format for Maradona Hand of God model")
    parser.add_argument("--excel_file", type=str, required=True, help="Path to the Excel file")
    parser.add_argument("--output_file", type=str, default="maradona_data.json", help="Output file path")
